...
const conditionIcons = {
    ...
    "HeavySnow": COLOR_244("     .-.     \n    (   ).   \n   (___(__)  ") + COLOR_255("\n   * * * *   \n  * * * *    "),
    "HeavySnowShowers": COLOR_226(" _`/\"\"") + COLOR_244(".-.    \n") + COLOR_226("  ,\\_") + COLOR_244("(   ).  \n") + COLOR_226("   /") + COLOR_244("(___(__) ") + COLOR_255("\n    * * * *  \n   * * * *   "),
    "LightRain": COLOR_250("     .-.     \n    (   ).   \n   (___(__)  ") + COLOR_111("\n   ʻ ʻ ʻ ʻ   \n  ʻ ʻ ʻ ʻ    "),
    "LightShowers": COLOR_226(" _`/\"\"") + COLOR_250(".-.    \n") + COLOR_226("  ,\\") + COLOR_250("_(   ).  \n") + COLOR_226("   /") + COLOR_250("(___(__) \n") + COLOR_111("    ʻ ʻ ʻ ʻ \n   ʻ ʻ ʻ ʻ  "),
    "LightSleet": COLOR_250("     .-.     \n    (   ).   \n   (___(__)  \n") + COLOR_111("   ʻ ") + COLOR_255("* ") + COLOR_111("ʻ ") + COLOR_255("*  \n  * ") + COLOR_111("ʻ ") + COLOR_255("* ") + COLOR_111("ʻ   "),
    "LightSleetShowers": COLOR_226(" _`/\"\"") + COLOR_250(".-.    \n") + COLOR_226("  ,\\_") + COLOR_250("(   ).  \n") + COLOR_226("   /") + COLOR_250("(___(__) \n") + COLOR_111("    ʻ") + COLOR_255(" *") + COLOR_111(" ʻ ") + COLOR_255("* \n   *") + COLOR_111(" ʻ ") + COLOR_255("* ") + COLOR_111("ʻ  "),
    "LightSnow": COLOR_250("     .-.     \n    (   ).   \n   (___(__)  \n") + COLOR_255("    *  *  *  \n   *  *  *   "),
    "LightSnowShowers": COLOR_226(" _`/\"\"") + COLOR_250(".-.    \n") + COLOR_226("  ,\\_") + COLOR_250("(   ).  \n") + COLOR_226("   /") + COLOR_250("(___(__) \n") + COLOR_255("    *  *  * \n   *  *  *  "),
    "PartlyCloudy": COLOR_226("   \\__/      \n __/  ") + COLOR_250(".-.    \n") + COLOR_226("   \\_") + COLOR_250("(   ).  \n") + COLOR_226("   /") + COLOR_250("(___(__) \n             "),
    "Sunny": COLOR_226("    \\   /    \n     .-.     \n  ‒ (   ) ‒  \n     `-᾿     \n    /   \\    "),
    "ThunderyHeavyRain": COLOR_244("     .-.     \n    (   ).   \n   (___(__)  \n") + COLOR_33("  ‚ʻ") + COLOR_228("⚡") + COLOR_33("ʻ‚") + COLOR_228("⚡") + COLOR_33("‚ʻ   \n  ‚ʻ‚ʻ") + COLOR_228("⚡") + COLOR_33("ʻ‚ʻ   "),
    "ThunderyShowers": COLOR_226(" _`/\"\"") + COLOR_250(".-.    \n") + COLOR_226("  ,\\_") + COLOR_250("(   ).  \n") + COLOR_226("   /") + COLOR_250("(___(__) \n") + COLOR_228("    ⚡") + COLOR_111("ʻ ʻ") + COLOR_228("⚡") + COLOR_111("ʻ  \n    ʻ ʻ ʻ ʻ  "),
    "ThunderySnowShowers": COLOR_226(" _`/\"\"") + COLOR_250(".-.    \n") + COLOR_226("  ,\\_") + COLOR_250("(   ).  \n") + COLOR_226("   /") + COLOR_250("(___(__) \n") + COLOR_255("    *  *  * \n   *  *  *  "),
